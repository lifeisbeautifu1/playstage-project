...
var Game = (function () {
  ...
  function drawSquares(gridIndex) {
    ...
    //context[gridIndex].fillStyle = '#6366f1';
    context[gridIndex].fillStyle = '#c7d2fe';
    ...
    for (i = 0; i < gridRows; i++) {
      for (j = 0; j < gridCols; j++) {
        ...
        context[gridIndex].fillStyle = '#FFF';
  ...
  function drawShips(gridIndex) {
    ...
    // context[gridIndex].fillStyle = '#312e81';
    ...
    for (i = 0; i < grid[gridIndex].ships.length; i++) {
      ...
      x = ship.x * (squareWidth + gridBorder) + gridBorder;
      y = ship.y * (squareHeight + gridBorder) + gridBorder;
      shipWidth = squareWidth;
      shipLength = squareWidth * ship.size + gridBorder * (ship.size - 1);
      if (gridIndex === 0) {
        context[gridIndex].strokeStyle = '#4338ca';
      } else {
        context[gridIndex].strokeStyle = 'red';
        context[gridIndex].fillStyle = '#fafafa';
      }
      context[gridIndex].lineWidth = 2;
      if (ship.horizontal) {
        if (gridIndex === 0) {
          context[gridIndex].strokeRect(x, y, shipLength, shipWidth);
        } else {
          // context[gridIndex].fillRect(x - shipWidth, y, shipLength, shipWidth);
          // context[gridIndex].fillRect(
          //   x - shipWidth,
          //   y + shipWidth,
          //   shipLength,
        ...
        if (gridIndex === 0) {
          context[gridIndex].strokeRect(x, y, shipWidth, shipLength);
        } else {
          context[gridIndex].strokeRect(x, y, shipWidth, shipLength);
        }
      }
    ...
    for (i = 0; i < gridRows; i++) {
      for (j = 0; j < gridCols; j++) {
        ...
        // draw red circle if hit on square
          ...
          context[gridIndex].strokeStyle = '#e62e2e';
          context[gridIndex].stroke();
          // context[gridIndex].beginPath();
