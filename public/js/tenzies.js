/*! For license information please see main.57df56a0.js.LICENSE.txt */
!(function () {
  var e = {
      425: function (e, t, n) {
        var r;
      ...
      463: function (e, t, n) {
        ...
        function Yr(e, t, n, r, a) {
          for (var l = t._reactName, o = []; null !== n && n !== r; ) {
            ...
            5 === i.tag &&
              ...
              ((i = s),
              a
                ? null != (u = Me(n, l)) && o.unshift(Qr(n, u, i))
                : a || (null != (u = Me(n, l)) && o.push(Qr(n, u, i)))),
              (n = n.return);
          }
        ...
        function vl(e, t, n, r) {
          ...
          'object' === typeof l && null !== l
            ? (a.context = Ja(l))
            : ((l = Ma(t) ? za : Oa.current), (a.context = Ta(e, l))),
          ...
          if (Ml) {
            ...
            if (t) {
              ...
              if (!Rl(e, t)) {
                ...
                t && Rl(e, t)
                  ? Il(r, n)
                  : ((e.flags = (-4097 & e.flags) | 2), (Ml = !1), (zl = e));
              }
            } else {
              if (Dl(e)) throw Error(l(418));
              (e.flags = (-4097 & e.flags) | 2), (Ml = !1), (zl = e);
        ...
        function Ql(e) {
          ...
          function s(e, t, n, r) {
            ...
            return l === x
              ...
              : (((r = Ls(n.type, n.key, n.props, null, e.mode, r)).ref = Bl(
                  e,
                  t,
                  n
                )),
          ...
          function d(e, t, n) {
            ...
            if ('object' === typeof t && null !== t) {
              switch (t.$$typeof) {
                case k:
                  return (
                    ((n = Ls(t.type, t.key, t.props, null, e.mode, n)).ref = Bl(
                      e,
                      null,
                      t
                    )),
          ...
          function m(a, l, i, u) {
            ...
            if (m === i.length) return n(a, f), Ml && _l(a, m), s;
            if (null === f) {
              for (; m < i.length; m++)
                null !== (f = d(a, i[m], u)) &&
                  ((l = o(f, l, m)),
          ...
          function v(a, i, u, s) {
            ...
            if (g.done) return n(a, m), Ml && _l(a, v), c;
            if (null === m) {
        ...
        function zo(e, t, n, r) {
          (t.value = n), (t.getSnapshot = r), Mo(t) && Ju(e, 1, -1);
        }
        function To(e, t, n) {
          return n(function () {
            Mo(t) && Ju(e, 1, -1);
        ...
        function xi(e, t, n, r, a) {
          ...
          return (
            ...
            (n = ko()),
            null === e || ki
              ? (Ml && n && Ol(t), (t.flags |= 1), Si(e, t, r, a), t.child)
        ...
        function Oi(e, t, n, r, a) {
          ...
          return (
            ...
            (r = ko()),
            null === e || ki
              ? (Ml && r && Ol(t), (t.flags |= 1), Si(e, t, n, a), t.child)
              : ((t.updateQueue = e.updateQueue),
                (t.flags &= -2053),
                (e.lanes &= ~a),
                Hi(e, t, a))
        ...
        function ji(e, t, n, r) {
          ...
          return (
            (e = a.sibling),
            (n = Ms(a, { mode: 'visible', children: n })),
        ...
        function Ui(e, t, n, r, a) {
          ...
          return (
            ...
            null !== o ? (r = Ms(o, r)) : ((r = Is(r, l, a, null)).flags |= 2),
            (r.return = t),
            (n.return = t),
            (n.sibling = r),
            (t.child = n),
        ...
        wu = function (e, t, n) {
                  ...
                  (function (e, t, n) {
                    switch (t.tag) {
                      ...
                      case 10:
                        ...
                        _a(Qa, r._currentValue), (r._currentValue = a);
                        break;
                      case 13:
          ...
          else (ki = !1), Ml && 0 !== (1048576 & t.flags) && Pl(t, wl, t.index);
              ...
              e: {
                ...
                if (((r = i.element), o.isDehydrated)) {
                  if (
                    ...
                    t = Mi(e, t, r, n, (a = Error(l(423))));
                    break e;
                  }
                  if (r !== a) {
                    t = Mi(e, t, r, n, (a = Error(l(424))));
                    break e;
                  }
                  for (
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      var u = n(184);
      function s(e) {
        var t = { backgroundColor: e.isHeld ? '#59E391' : 'white' };
        return (0, u.jsxs)('div', {
          className: 'die-face face-'.concat(e.value),
          style: t,
          onClick: e.holdDice,
          children: [
            (0, u.jsx)('span', { className: 'dot' }),
            (0, u.jsx)('span', { className: 'dot' }),
            (0, u.jsx)('span', { className: 'dot' }),
            (0, u.jsx)('span', { className: 'dot' }),
            (0, u.jsx)('span', { className: 'dot' }),
      ...
      function p() {
        var t = i(e.useState(_()), 2),
          ...
          y = v[0],
          g = v[1],
          b = i(e.useState(new Date()), 2),
          w = b[0],
          k = b[1],
          S = i(e.useState(new Date()), 2),
          x = S[0],
          E = S[1];
        function C() {
          return { value: Math.ceil(6 * Math.random()), isHeld: !1, id: c() };
        }
        function _() {
          for (var e = [], t = 0; t < 10; t++) e.push(C());
          return e;
        }
        e.useEffect(
          function () {
            ...
            e &&
              ...
              (f(!0),
              E(new Date()),
              fetch('/dashboard/tenzies/gameover', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                  rolls: h,
                  time: (w.getTime() - x.getTime()) / 1e3,
                }),
              }).then(function (e) {
                return e.json();
              }));
        ...
        return (0, u.jsxs)('main', {
          children: [
            o && (0, u.jsx)(d(), {}),
            (0, u.jsx)('h1', { className: 'title', children: 'Tenzies' }),
            (0, u.jsx)('p', {
              ...
              children: o
                ? 'Rolls: '
                    .concat(h, '\n Time: ')
                    .concat(
                      ((x.getTime() - w.getTime()) / 1e3).toFixed(0),
                      '(s)'
                    )
                : 'Roll until all dice are the same. Click each die to freeze it at its current value between rolls.',
            }),
            (0, u.jsx)('div', { className: 'dice-container', children: P }),
            (0, u.jsx)('button', {
              className: 'roll-dice',
              onClick: function () {
                o
              ...
              children: o ? 'New Game' : 'Roll',
            }),
          ],
        });
      }
      t.createRoot(document.getElementById('root')).render((0, u.jsx)(p, {}));
    })();
})();
//# sourceMappingURL=main.57df56a0.js.map
